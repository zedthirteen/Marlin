...
#define STRING_CONFIG_H_AUTHOR "DField, Prusa TMC2130" // Who made the changes.
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
// 2022-03-03 DJF Update serial port
...
// 20240326 configure for TMC2130 Dual extruder, Dual Z
 ...
 */
#define TEMP_SENSOR_0  1 // 2020-12-24 DJF was 1
#define TEMP_SENSOR_1  1 // 2020-12-24 DJF was 0
...
// 2020-03-16 DJF sensorless homing needs x min end stop inverting set to true
#define X_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop.
#define Y_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop.
// 2020-01-02 DJF - My proximity sensor is NPN and this appears to work when true
// M8 2mm 5V DC NPN NO LJ8A3-2-Z/BX-5V Proximity Inductive Sensor Switch 
...
// 2024-03-26 DJF - My proximity sensor is NPN and this appears to work when true
 ...
 */
// DJF was: #define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 156.84 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
// 2022-03-04 DJF Reduce max acceleration to try to prevent overheating
 ...
 */
// 2022-03-04 DJF Reduce acceleration to try to prevent overheating
...
// 2021-01-24 DJF Probably should force probe z homing?
 ...
 */
// 20240326 DJF - enable FIX_MOUNTED_PROBE
 ...
 *     O-- FRONT --+
 */
// 2020-01-02 DJF - update for my proximity sensor location
//#define NOZZLE_TO_PROBE_OFFSET { 23, 5, -0.52 } // Z -0.54
// 2020-04-13 DJF - my Z probe offset is -0.5
 ...
 */
// 20240326 DJF - set muliple probing to 3
...
// 20240326 DJF enable repeatability test
...
// DJF To Do - work out sizes for new print bed X = 184, Y = 219
// 2020-01-03 DJF - New sizes for dual head carriage (through trial and error)
//
...
// 2020-04-13 DJF - Enable soft endstops menu item
...
// 2020-01-02 DJF - Enable auto bed levelling
 ...
 */
// 2020-03-16 - Enable Z_SAFE_HOMING for Z probe
 ...
 */
// 2021-01-24 DJF - DotBit Armed board form amazon did not have EEPROM - now fitted!
// 2020-10-06 DJF - EEPROM did not have voltage jumper set on ARMed board
//// 2020-04-13 DJF - Enable EEPROM Settings - did not work
...
// 2022-03-04 DJF turn on both of these options for EEPROM
 ...
 */
// 2020-03-28 DJF SD Support requires nozzle park feature
 ...
 * :[0:'Classic', 1:'Průša']
 */
// 2020-03-28 DJF Change Info screen to Prusa Style
 ...
 */
// 2020-03-28 DJF enable SD card support
//#define SDSUPPORT
#define SDSUPPORT
 ...
 */
// 2020-04-11 DJF - Try slower speed on SD card 2021-06-24 dJF disable speed reduction
...
//
// 2020-04-11 DJF - My encoder was causing values to decrease when turned clockwise
...
//
// 2020-04-11 DJF - I prefer individual homing options
...
//
// 2020-12-26 DJF disable speaker as think it is causing timer conflict
// with timers
//#define SPEAKER
...
//
// 2020-03-28 DJF - Enable LCD controller

...
//20240326 DJF This was enabled in old configuration_adv.h but not sure it is required
 ...
 */
// 2022-03-05 DJF - Use auto controller fan and change from FAN2 to FAN0
// 20240719 DJF - I think CONTROLLER_FAN_PIN should just be FAN_PIN (FAN_PIN2 shodul be for hotend cooling)
 ...
 */
// 20240719 DJF - set up extruder 0 fan pin
//#define E0_AUTO_FAN_PIN -1
#define E0_AUTO_FAN_PIN FAN2_PIN // - doesn't like this
...
// 20240719 DJF try setting cooler auto fan pin for part cooling 
//#define COOLER_AUTO_FAN_PIN -1
#define COOLER_AUTO_FAN_PIN FAN1_PIN
// 20240326 DJF this was active in old config
/*
 ...
 */
// 2022-03-05 DJF - switch to separate Z stepper drivers
...
// LCD Print Progress options. Multiple times may be displayed in turn.
   ...
   */
  // 2024-03-26 DJF try to enable this
 ...
 */
// 20240716 DJF enable ADVANCED_PAUSE_FEATURE
...
// 20240719 DJF - incerease uload feed rate to 100mm/s
...
// 20240719 DJF - enable park head on pause
 ...
 */
   ...
   */
  // 2022-03-04 DJF turn off interpolation to reduce temperature
   ...
   */
// 20240326 DJF enable sensorless homing
  //#define SENSORLESS_HOMING // StallGuard capable drivers only
  #define SENSORLESS_HOMING // StallGuard capable drivers only

  #if EITHER(SENSORLESS_HOMING, SENSORLESS_PROBING)
    // TMC2209: 0...255. TMC2130: -64...63
    // 2020-04-12 DJF - try different stall sensitivity - 4 is now working for X and 2 for Y
    // 2020-04-13 DJF - 3 seems to be workign for both at 500ma
    //#define X_STALL_SENSITIVITY  8
    #define X_STALL_SENSITIVITY  3 // seems to work from menu
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    //#define Y_STALL_SENSITIVITY  8
    #define Y_STALL_SENSITIVITY    3 // seems to work from menu
    ...
    // 2020-04-04 DJF - enable SPI end stops and improve homing
    //#define SPI_ENDSTOPS              // TMC2130/TMC5160 only
    #define SPI_ENDSTOPS              // TMC2130 only
    //#define IMPROVE_HOMING_RELIABILITY
// 20240326 DJF -0 enable improve homing reliability
    #define IMPROVE_HOMING_RELIABILITY
  #endif
